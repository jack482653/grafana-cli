...
- Node.js 18+, TypeScript 5.x (ES2022) + commander 14.x, axios 1.x (existing, no new dependencies) (005-datasource-folder-list)
- N/A (no local persistence; reads directly from Grafana API) (005-datasource-folder-list)
